...
class Comic < Linkbot::Plugin
  ...
  description "Random fffffuuuuuuu comic"
  ...
  def self.on_message(message, matches, config)
    ...
    1.upto(times) do
      ...
      puts subreddit
      doc = JSON.parse(open(subreddit, "Cookie" => "reddit_session=8390507%2C2011-03-22T07%3A06%3A44%2C2516dcc69a22ad297b9900cbde147b365203bbbb").read)
